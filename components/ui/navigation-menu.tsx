...
import { Platform, View, PressableStateCallbackType } from 'react-native';
import Animated, {
  Extrapolation,
  FadeInLeft,
  FadeOutLeft,
...
const NavigationMenuTrigger = React.forwardRef<
  ...
  NavigationMenuPrimitive.TriggerProps & { children: React.ReactNode | ((state: PressableStateCallbackType) => React.ReactNode) }
>(({ className, children, ...props }, ref) => {
